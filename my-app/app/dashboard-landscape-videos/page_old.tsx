    ...
    <main className="relative min-h-screen py-32 text-white font-redHatDisplay">
      ...
      <div className="relative mx-auto flex w-full max-w-8xl items-start gap-6 px-6 lg:pl-[17rem]">
        <aside className="fixed left-6 top-28 z-40 hidden h-fit w-56 shrink-0 lg:block">
          {leftColumnLoading ? (
            <LeftColumnLoadingBox videoSections={videoSections} />
          ) : (
            <Card className="rounded-3xl border-amber-400/20 bg-black/45 shadow-[0_0_18px_rgba(245,158,11,0.5)] backdrop-blur-md">
              <CardContent className="space-y-12 p-4">
                ...
                <nav className="space-y-6">
                  ...
                  <Button
                    type="button"
                    className="flex h-10 w-full cursor-pointer items-center justify-center gap-2 rounded-xl border border-gray-300/20 
                               bg-black/30 font-marcellus text-lg text-gray-100 transition-all duration-300 
                               hover:border-amber-300/30 hover:bg-white/10 hover:text-amber-200 hover:shadow-[0_0_12px_rgba(245,158,11,0.18)]"
                  >
        ...
        <section className="min-w-0 flex-1 space-y-12">
          ...
          >
            ...
            <Button
              asChild
              className="group relative h-11 cursor-pointer overflow-hidden
                         rounded-xl bg-amber-400 px-5 text-xl font-bold text-black
                         shadow-[0_0_14px_rgba(245,158,11,0.35)] transition-shadow duration-300
                         hover:shadow-[0_0_22px_rgba(245,158,11,0.6)]"
            >
              <Link href="/dashboard-portrait-videos">
                <span
                  className="absolute inset-0 origin-right bg-amber-600
...
function LeftColumnLoadingBox({
  ...
  videoSections: typeof initialLandscapeVideoSections;
}) {
  return (
    <Card
      className="relative overflow-hidden rounded-3xl border-amber-400/15 bg-black/45 
                     shadow-[0_0_18px_rgba(245,158,11,0.25)] backdrop-blur-md"
    >
      <div
        className="pointer-events-none absolute inset-0 -translate-x-full animate-[sidebar-shimmer_2s_infinite] 
      ...
      <CardContent className="relative space-y-12 p-4">
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-2">
            {Array.from({ length: videoSections.length + 1 }).map(
              (_, index) => (
                <div
                  key={index}
  ...
  return (
    <section className="rounded-3xl border border-amber-400/15 bg-black/40 p-10 shadow-[0_0_18px_rgba(245,158,11,0.12)] backdrop-blur-md">
      <div className="mx-auto flex max-w-xl flex-col items-center">
        ...
        <Button
          className="group relative mt-6 h-11 cursor-pointer overflow-hidden rounded-xl bg-amber-400 px-5 font-bold text-lg text-black 
                           shadow-[0_0_14px_rgba(245,158,11,0.35)] transition-shadow duration-300 hover:shadow-[0_0_22px_rgba(245,158,11,0.6)]"
        >
          <span className="absolute inset-0 origin-top bg-amber-600 transition-transform duration-500 ease-[cubic-bezier(0.22,1,0.36,1)] group-hover:scale-y-0" />
          <span className="relative z-10 flex items-center gap-2">
            ...
            <DropdownMenu modal={false}>
              <DropdownMenuTrigger asChild>
                <Button
                  ...
                  className="shrink-0 cursor-pointer rounded-full bg-black/40 text-gray-200 border-none
                             transition-all duration-300 hover:-translate-y-0.5 hover:bg-amber-400/80 hover:text-black hover:shadow-[0_0_18px_rgba(245,158,11,0.45)] 
                             data-[state=open]:bg-amber-400/80 data-[state=open]:text-black data-[state=open]:shadow-[0_0_18px_rgba(245,158,11,0.45)]"
                >
  ...
  return (
    ...
    >
      {video.sourceType === "youtube" && video.youtubeEmbedUrl ? (
        ...
        <Button
          type="button"
          className="relative h-full w-full cursor-pointer overflow-hidden p-0
                     rounded-none"
        >
          <Image
