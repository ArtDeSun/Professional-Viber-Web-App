...
This web application features a personalized digital marketing platform for an independent musician surviving in the social media age.
...
The [Next.js](https://nextjs.org) framework introduces end-to-end development of a functional website for a variety of use cases. For reference, you can create a sleek landing page to attract more clients for professional service. More excitingly, you can design an online portolio showcasing the talents of an artist.
...
- MongoDB integration.
- Vercel deployment.
- Selective coverage tests.
- Cybersecurity measures after developing a payment system (possibly Stripe integration).
- Containerization.
- Search Engine Optimization (SEO).

## Getting Started

First, navigate to `/my-app`:

```bash
cd my-app
```

Then follow the [instructions](https://github.com/ArtDeSun/Professional_Viber_Web_App/tree/main/my-app) in `/my-app`.
